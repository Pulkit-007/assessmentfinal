      ...
      child: Scaffold(
        ...
        Column(
          children: [
            ...
            Text("WELCOME TO FLUTTER TRAINING",style: TextStyle(fontSize: 20,color: Colors.lightBlue,decoration: TextDecoration.none,fontWeight: FontWeight.bold),),
            Padding(padding: EdgeInsets.only(top: 40,bottom: 30)),
            Image(image: AssetImage("assets/flutter.jpg")),
            Padding(padding: EdgeInsets.only(top: 40,bottom: 30)),
            SizedBox(child: ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) {
              return User_login();}));}, child: Text("Get Started"),style: ElevatedButton.styleFrom(primary: Colors.lightBlue),),
              width: 300,),
          ],
      ...
      SafeArea(
        child: Column
          ...
          children: [
            ...
            Image(image: AssetImage("assets/certificate.jpg")),
